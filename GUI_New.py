        ...
        for i, (img, value) in enumerate(values.items()):
            if i < 2:
                Radiobutton(sideButtons, bg="white", image=img, variable=self.shape,
                            value=value, indicator=0, height=50, width=50).grid(row=i, column=0, padx=5, pady=5,
                                                                                sticky=W)
            else:
                Radiobutton(sideButtons, bg="white", image=img, variable=self.shape,
                            value=value, indicator=0, height=50, width=50).grid(row=i - 2, column=1, padx=5, pady=5,
                                                                                sticky=W)
            ...
            class LabelingApp(tkinter.Tk):
                ...
                def __init__(self):
                    ...
                    for i, (img, value) in enumerate(values.items()):
                        if i < 2:
                            Radiobutton(sideButtons, bg="white", image=img, variable=self.shape,
                                        value=value, indicator=0, height=50, width=50).grid(row=i, column=0, padx=5,
                                                                                            pady=5, sticky=W)
                        else:
                            Radiobutton(sideButtons, bg="white", image=img, variable=self.shape,
                                        value=value, indicator=0, height=50, width=50).grid(row=i - 2, column=1, padx=5,
                                                                                            pady=5, sticky=W)
